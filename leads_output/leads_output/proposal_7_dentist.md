...
- Substantial content (1231 words)
- robots.txt present
- sitemap.xml present
- HTTPS enabled
...
8. Add social media profile links
9. Add structured data (FAQ, LocalBusiness, Service schemas)
10. Create llms.txt file for AI assistant visibility
